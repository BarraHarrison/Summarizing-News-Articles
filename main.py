...
tlabel.pack()
title = tk.Text(root, height=1, width=140, bg='lightblue', state='disabled')
title.pack()

alabel = tk.Label(root, text='Author')
alabel.pack()
author = tk.Text(root, height=1, width=140, bg='lightblue', state='disabled')
author.pack()

plabel = tk.Label(root, text='Publication Date')
plabel.pack()
publication = tk.Text(root, height=1, width=140, bg='lightblue', state='disabled')
publication.pack()

slabel = tk.Label(root, text='Summary')
slabel.pack()
summary = tk.Text(root, height=20, width=140, bg='lightblue', state='disabled')
summary.pack()

selabel = tk.Label(root, text='Sentiment Analysis')
selabel.pack()
sentiment = tk.Text(root, height=1, width=140, bg='lightblue', state='disabled')
sentiment.pack()

ulabel = tk.Label(root, text='URL')
ulabel.pack()
utext = tk.Text(root, height=1, width=140, bg='lightblue')
utext.pack()
